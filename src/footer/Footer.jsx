...
export default function Footer() {
  ...
  return (
    <div className='foot-container'>
      <div className="footer-sep">
        <div className="gratitude">
          ...
          <span style={{ display: "flex", alignItems: "center", gap:"20px", paddingTop:"30px" }}>
             <Link to='https://github.com/settings/two_factor_checkup?'><InstagramIcon className='IC' style={{ fontSize: "30px"}} /></Link> 
              <XIcon className='IC' style={{ fontSize: "30px"}}></XIcon>
              <FacebookIcon className='IC' style={{ fontSize: "30px"}}></FacebookIcon>
              <LinkedInIcon className='IC' style={{ fontSize: "30px"}}></LinkedInIcon>
          </span>
          </div>
        </div>
      ...
      <div class="copyright">
        <p>Copyright &copy; 2025. All Rights Reserved. — Designed with love by <a href="SSS">Swa NJ</a></p>
        <ul>
